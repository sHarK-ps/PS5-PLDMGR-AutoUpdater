...
| **zftpd** | seregonwar | Ps5 Server | [v1.5.0](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_server/zftpd/v1.5.0) | `68a80e1cb4...` | FTP server payload for PS5. Port: 21 |
...
| **ftpsrv** | ps5-payload-dev | Ps5 Server | [v0.20](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_server/ftpsrv/v0.20) | `23f69de0f1...` | FTP server background daemon. Port: 21 |
...
| **ps5-self-pager** | idlesauce | Ps5 Sdk Debug | [v1.2](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_sdk_debug/ps5-self-pager/v1.2) | `2b500bc356...` | SELF pager payload tool. |
| **PS5-SELF-Decrypter** | idlesauce | Ps5 Sdk Debug | [v0.5.2](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_sdk_debug/PS5-SELF-Decrypter/v0.5.2) | `46340d3048...` | SELF decrypter tool for PS5 binaries. |
