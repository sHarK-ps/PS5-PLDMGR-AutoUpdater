...
| **zftpd** | seregonwar | Ps5 Server | [v1.5.0](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_server/zftpd/v1.5.0) | `9340aa91f8...` | FTP server payload for PS5. Port: 21 |
...
| **ftpsrv** | ps5-payload-dev | Ps5 Server | [v0.20](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_server/ftpsrv/v0.20) | `8f305a959f...` | FTP server background daemon. Port: 21 |
...
| **ftpsrv (drakmor)** | drakmor | Ps5 Server | [1.6-ng-test2](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_server/ftpsrv_(drakmor)/1.6-ng-test2) | `6364e05294...` | Drakmor's variant of the FTP server. Port: 21 |
...
| **ps5debug-NG** | OpenSourcereR-dev | Ps5 Sdk Debug | [1.2.7](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_sdk_debug/ps5debug-NG/1.2.7) | `bfb0786561...` | Next generation debugger payload for PS5. |
...
| **ps5-self-pager** | idlesauce | Ps5 Sdk Debug | [v1.2](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_sdk_debug/ps5-self-pager/v1.2) | `fb498d4112...` | SELF pager payload tool. |
| **PS5-SELF-Decrypter** | idlesauce | Ps5 Sdk Debug | [v0.5.2](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_sdk_debug/PS5-SELF-Decrypter/v0.5.2) | `6a16c6457c...` | SELF decrypter tool for PS5 binaries. |
...
| **kstuff** | EchoStretch | Ps5 Kstuff | [v1.6.7](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_kstuff/kstuff/v1.6.7) | `f1c1f4b2b6...` | Fnd Kstuff payload for PS5. |
| **kstuff-lite** | EchoStretch | Ps5 Kstuff | [v1.07](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_kstuff/kstuff-lite/v1.07) | `eb730eccd1...` | Lightweight version of kstuff. |
| **kstuff-lite (drakmor)** | drakmor | Ps5 Kstuff | [1.2-dr-test2](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_kstuff/kstuff-lite_(drakmor)/1.2-dr-test2) | `2b699d4110...` | Drakmor's variant of kstuff-lite. |
...
| **ELF Arsenal** | SonicIso | Ps5 HEN Loader | [v1.6.21](https://github.com/nexgen999/PS5-Super-PLDMGR-Auto-Updater/tree/main/payloads/ps5_hen_loader/ELF_Arsenal/v1.6.21) | `cec8008893...` | Boîte à outils regroupant une collection complète de payloads utilitaires pour les consoles jailbreakées. |
...
- **EchoStretch** : [kstuff](https://github.com/EchoStretch/kstuff)
...
- **ps5-payload-dev** : [ftpsrv](https://github.com/ps5-payload-dev/ftpsrv)
