...
| **pldmgr** | [v0.4.1](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_hen_loader/PS5_Payload_Manager/v0.4.1/pldmgr_v0.4.1.elf) | `8f26faf1f6...` | Interface d'administration et de gestion réseau pour envoyer, activer et ordonner vos fichiers ELF/BIN sur la console. |
...
| **ps5upload** | [v4.1.2](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_server/ps5upload/v4.1.2/ps5upload_v4.1.2.elf) | `4ecdd43a63...` | PS5 Upload server / tool. Port: 9025 |
