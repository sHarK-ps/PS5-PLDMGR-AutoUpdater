...
> `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/payloads.json`
...
| :--- | :--- | :--- | :--- |
| **np-fake-signin** | [v1.3](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/PS5_Activation/np-fake-signin/v1.3/np-fake-signin_v1.3.elf) | `f5c66fcb9e...` | Fake activate PS5 without PSN. |
...
| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **CheatRunner** | [v0.14](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/PS5_Cheat/CheatRunner/v0.14/CheatRunner_v0.14.elf) | `5ffe8ed97f...` | CheatRunner. |
...
### 🌐 Ps5 Dns
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_dns.json`
...
### 📂 Ps5 File Explorer
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_file_explorer.json`

| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **bfpilot-core** | [Source-Fixe](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_file_explorer/BFpilot-Core/Source-Fixe/bfpilot-core_v0.2.1.elf) | `4375479705...` | BFpilot is a lightweight PS5 payload that serves a browser-based file manager. |
| **bfpilot-full** | [Source-Fixe](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_file_explorer/BFpilot-Full/Source-Fixe/bfpilot-full_v0.2.1.elf) | `c5b6674533...` | BFpilot is a lightweight PS5 payload that serves a browser-based file manager. |
| **lapy_jb_daemon** | [Source-Fixe](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_file_explorer/Lapy_JB_Daemon/Source-Fixe/lapy_jb_daemon.elf) | `e8230ac459...` | Daemon pour le jailbreak de Lapy |

### 💾 Ps5 Freeshop
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_freeshop.json`

| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **Spectrum-Library** | [1.4.2](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_freeshop/Spectrum-Library/1.4.2/Spectrum-Library_v1.4.2.elf) | `54755ce62d...` | free store webadmin http://your-ps5-ip:7575. |
| **pegasus-dl** | [v1.6.0](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_freeshop/pegasus-dl/v1.6.0/pegasus-dl_v1.6.0.elf) | `29b62ef500...` | free store webadmin http://your-ps5-ip:6970. |
...
| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **PS5-Game-Compressor** | [v1.0.3](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_game_dump/PS5-Game-Compressor/v1.0.3/PS5-Game-Compressor_v1.0.3.elf) | `51b66edf62...` | Tool to compress PS5 games. |
| **ps5-app-dumper** | [v1.10](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_game_dump/ps5-app-dumper/v1.10/ps5-app-dumper_v1.10.elf) | `95382a9e37...` | PS5 App Dumper payload. |
| **ShadowMountPlus** | [1.6test15-fix2](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_game_dump/ShadowMountPlus/1.6test15-fix2/ShadowMountPlus_v1.6test15-fix2.elf) | `8ab32f4ced...` | ShadowMountPlus payload for game mounting. |
...
### 🚀 Ps5 HEN Loader
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_hen_loader.json`
...
| **ELF_Arsenal** | [v1.6.21](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_hen_loader/ELF_Arsenal/v1.6.21/ELF_Arsenal_v1.6.21.elf) | `cec8008893...` | Boîte à outils regroupant une collection complète de payloads utilitaires pour les consoles jailbreakées. |
...
| **kstuff-lite_EchoStretch** | [v1.07](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_kstuff/kstuff-lite_EchoStretch/v1.07/kstuff-lite_EchoStretch_v1.07.elf) | `eb730eccd1...` | Lightweight version of kstuff. |
...
### 🐧 Ps5 Linux
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_linux.json`
...
### ⚙️ Ps5 Sdk Debug
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_sdk_debug.json`

| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **ps5debug-NG** | [1.3.0](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_sdk_debug/ps5debug-NG/1.3.0/ps5debug-NG_v1.3.0.elf) | `8f75fb90b4...` | Next generation debugger payload for PS5. |
...
### 🖥️ Ps5 Server
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_server.json`
...
| **elfldr** | [v0.23](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_server/elfldr/v0.23/elfldr_v0.23.elf) | `092d16ee0e...` | ELF Loader utility. Port: 9020 / 9021 |
| **ftpsrv_ps5-payload** | [v0.20](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_server/ftpsrv_ps5-payload/v0.20/ftpsrv_ps5-payload_v0.20.elf) | `8f305a959f...` | FTP server background daemon. Port: 21 |
| **websrv** | [v0.32](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_server/websrv/v0.32/websrv_v0.32.elf) | `8dd24df100...` | HTTP Web server payload. Port: 8080 |
...
| **ps5upload** | [v3.3.22](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_server/ps5upload/v3.3.22/ps5upload_v3.3.22.elf) | `6fac6e1fa5...` | PS5 Upload server / tool. Port: 9025 |
...
### 📦 Ps5 Themes-Avatars
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_themes-avatars.json`

| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **PS5-Custom-Tool-Manager-** | [Custom](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_themes-avatars/PS5-Custom-Tool-Manager-/Custom/PS5-Custom-Tool-Manager-_vCustom.elf) | `297824ceaf...` | Custom manager tool for PS5 personalization. |
| **ps5-wallpaper-modd** | [v1.0](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_themes-avatars/ps5-wallpaper-modd/v1.0/ps5-wallpaper-modd_v1.0.elf) | `b18a866bac...` | Wallpaper modification utility for PS5. |

### 🏆 Ps5 Trophy
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_trophy.json`

| Application | Version | Empreinte SHA-256 | Description |
| :--- | :--- | :--- | :--- |
| **uds-trophy-unlocker** | [v1.0.0](https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/payloads/ps5_trophy/uds-trophy-unlocker/v1.0.0/uds-trophy-unlocker_v1.0.0.elf) | `3a338eccaa...` | Trophy unlocker utility for PS5 hosted on Forgejo. |

### 🛠️ Ps5 Utility
📂 **Fichier JSON Dédié :** `https://shark-ps.github.io/PS5-PLDMGR-AutoUpdater/json/ps5_utility.json`
